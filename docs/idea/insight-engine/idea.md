...
> **Analysis Date:** 2026-04-16 (Phase 10 update: 2026-04-18; Phase 13 update: 2026-04-19)
> **Status:** REVIEWED — READY (Phase 0-12 DONE; Phase 13 PLANNED)
...
Quy trình này tốn thời gian, dễ sai sót, lặp lại liên tục, và đòi hỏi sử dụng nhiều công cụ khác nhau mà không có một luồng xử lý thống nhất. Ngoài ra, việc tìm kiếm dữ liệu có cấu trúc (sales lead, tin tuyển dụng, sản phẩm, hồ sơ công ty) trên nhiều nền tảng đòi hỏi kiến thức chuyên biệt mà các công cụ AI hiện tại không đáp ứng được. Cuối cùng, **requirement drift** — sau nhiều bước thực thi, AI mất dần track của yêu cầu ban đầu, dẫn đến output cuối sai hoàn toàn dù từng bước trông có vẻ đúng.
